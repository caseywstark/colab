...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'theme_advanced_buttons1': "bold, italic, underline, strikethrough, |, bullist, numlist, outdent, indent, blockquote, |, link, unlink, |, cut, copy, paste, pastetext, |, search, replace, |, undo, redo, |, removeformat",
