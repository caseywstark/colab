...
DEFAULT_MAX_COMMENT_LENGTH = getattr(settings, 'DEFAULT_MAX_COMMENT_LENGTH', 10000)
DEFAULT_MAX_COMMENT_DEPTH = getattr(settings, 'DEFAULT_MAX_COMMENT_DEPTH', 20)
...
class ThreadedCommentManager(models.Manager):
    ...
    """
    def get_tree(self, content_object, root=None, sort='date_submitted'):
        """
